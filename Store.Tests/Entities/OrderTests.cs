...
namespace Store.Tests.Entities
{
    ...
    {
        private readonly Customer _customer = new Customer("José Eduardo", "eduardo@gft.com");
        private readonly Product _product = new Product("Produto 1", 10, true);
        private readonly Discount _discount = new Discount(10, DateTime.Now.AddDays(15));
